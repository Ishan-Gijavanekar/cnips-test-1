...
func Execute(event string, config map[string]string, vars map[string]string, log *log.Logger) (string, map[string]string, error) {
	...
	return string(transformedEvent), vars, nil
}
