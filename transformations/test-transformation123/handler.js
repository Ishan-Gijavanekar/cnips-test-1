...
export async function execute(event, config, vars, LOG) {
    try {
        ...
        LOG.info("This is a test transformation for testing the cnips local transformation execution");

        LOG.info("This is for test");

        LOG.info("This is for testing the logging functionality. You can use different log levels like info, debug, warn, error, etc.");
